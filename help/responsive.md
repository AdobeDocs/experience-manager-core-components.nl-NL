...
Gezien de diverse manieren kunnen deze componenten ontvankelijk gedrag vertonen, en in Adobe die zich ertoe verbindt om de Componenten van de Kern lichtgewicht uit-van-de-doos te houden, wordt de verantwoordelijkheid voor het uitvoeren van gedetailleerde responsieve aspecten opzettelijk aan het project overgelaten.
