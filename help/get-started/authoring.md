...
description: In AEM zijn componenten de structuurelementen die de inhoud vormen van de pagina's die worden ontworpen. Core Components biedt flexibele en functiespecifieke ontwerpfunctionaliteit.
...
Voor een meer diepgaande, op ontwikkelaar-georiënteerde inleiding aan het uitvoeren van de Componenten van de Kern op een project van AEM door het ](/help/developing/archetype/overview.md) controle van de Archetype van het Project van AEM [ uit te gebruiken WKND leerprogramma.](https://experienceleague.adobe.com/docs/experience-manager-learn/getting-started-wknd-tutorial-develop/overview.html)[
...
De stijlen van de meeste Core Components kunnen worden gedefinieerd met het AEM-stijlsysteem.
