...
>[!NOTE]
>
>Dit schema is het generische schema van het componentenpunt dat als basispatroon voor verscheidene Componenten van de Kern wordt gebruikt. Dit garandeert niet dat elke vermelde component alle velden op elk item vult.
