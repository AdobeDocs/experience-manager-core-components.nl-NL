...
* Set `aemVersion=cloud` for [AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html);\
  Set `aemVersion=6.5.0` for [Adobe Managed Services](https://github.com/adobe/aem-project-archetype/tree/master/src/main/archetype/dispatcher.ams)of op locatie.
...
| `aemVersion` | `cloud` | Doelversie AEM (kan `cloud` for [AEM as a Cloud Service](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/landing/home.html); of `6.5.0`, of `6.4.4` for [Adobe Managed Services](https://github.com/adobe/aem-project-archetype/tree/master/src/main/archetype/dispatcher.ams) of op locatie). |
...
| `singleCountry` | `y` | Bevat een taalstramieninhoudsstructuur (kan `y`, of `n`). |
...
| `datalayer` | `y` | Integratie activeren met [Gegevenslaag client-Adobe](/help/developing/data-layer/overview.md). |
...
|---------|---------|---------|---------|---------|
| [47](https://github.com/adobe/aem-project-archetype/releases/tag/aem-project-archetype-47) | Continu | 6.5.7.0+ | 8, 11 | 3.3.9+ |
...
U kunt dit archetype in Eclipse niet gebruiken wanneer het beginnen van een nieuw project met `File -> New -> Maven Project` sinds het script voor na de generatie `archetype-post-generate.groovy` wordt niet uitgevoerd vanwege een [Uitknipprobleem.](https://bugs.eclipse.org/bugs/show_bug.cgi?id=514993) Als tussenoplossing kunt u de bovenstaande opdrachtregel gebruiken en daarna in Eclipse `File -> Import -> Existing Maven Project`.
