...
* Sommige componenten kunnen specifieke extra clientlibs hebben die voor gebruik in bepaalde situaties worden ontworpen, zoals wanneer tewerkgesteld naast [&#x200B; Dynamische Media &#x200B;](/help/components/image.md#dynamic-media) bijvoorbeeld.
...
Vaak wilt u de CSS-include-bestanden in het HTML `head` -element plaatsen en de JS-code wordt net vóór het sluiten van het `body` -element ingevoegd.
