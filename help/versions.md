...
|---|---|---|---|---|---|---|
| [ 2.27.0 ](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.27.0) | Deze versie is bedoeld voor een groot aantal opgeloste problemen. | - | 6.5.21.0+ | Continu | 8, 11 | 10 september 2024 |
...
| [ 2.23.2 ](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.23.2) | Deze flard voegde de slimme uitsnijding van Dynamic Media voor verre activa aan het [ Beeld ](/help/components/image.md) toe en [ Componenten van het Taser ](/help/components/teaser.md) en bevond een aantal insecten. | - | 6.5.17.0+ | Continu | 8, 11 | 4 augustus 2023 |
| [ 2.23.0 ](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.23.0) | Deze versie voegde steun voor [ de verre activa van Dynamic Media van de Volgende Generatie toe.](/help/developing/remote-assets.md) | - | 6.5.17.0+ | Continu | 8, 11 | 6 juni 2023 |
...
| [ 2.22.0 ](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.22.0) | Deze versie introduceert een nieuwe versie van de [ Component van de Lijst ](/help/components/list.md) samen met verbeteringen aan [ Taser ](/help/components/teaser.md) en update van de [ Kijker van de PDF ](/help/components/pdf-viewer.md) en [ Carousel ](/help/components/carousel.md) | - | 6.5.14.0+ | Continu | 8, 11 | 9 februari 2023 |
...
| [ 2.15.0 ](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.15.0) | Deze versie omvat steun voor [ progressieve Web apps (PWA) in de Component van de Pagina ](/help/components/page.md#pwa-support) en steunt versie 2.0.0 van de [ Laag van Gegevens van de Adobe.](/help/developing/data-layer/overview.md) | 6.4.8.1+ | 6.5.5.0+ | Continu | 8, 11 | 23 februari 2021 |
...
| [ 2.13.0 ](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.13.0) | Deze versie omvat nieuwe eigenschappen van Dynamic Media voor de [ Component van het Beeld.](/help/components/image.md) | 6.4.8.1+ | 6.5.5.0+ | Continu | 8, 11 | 4 december 2020 |
...
| [ 2.10.0 ](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.10.0) | Deze versie introduceerde de [ component van de Kijker van de PDF.](/help/components/pdf-viewer.md) | 6.4.8.1+ | 6.5.5.0+ | Continu | 8, 11 | 17 juni 2020 |
| [ 2.9.0 ](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.reactor-2.9.0) | Deze versie liet integratie met de [ Gegevens van de Cliënt van de Adobe Gegevens ](/help/developing/data-layer/overview.md) toe en introduceerde de [ component van de Bar van de Voortgang.](/help/components/progress-bar.md) | 6.4.8.0+ | 6.5.4.0+ | Continu | 8, 11 | 29 mei 2020 |
...
| [ 1.0.2 ](https://github.com/adobe/aem-core-wcm-components/releases/tag/core.wcm.components.all-1.0.2) | Deze versie voegt moeilijke situaties voor geanimeerde beelden van het GIF in [ Component van het Beeld toe.](/help/components/image.md) | 6.4.0.0+ | - | - | 7 | 22 maart 2017 |
...
| **[de Kijker van de PDF](components/pdf-viewer.md)** |  |  |  |  |  |  |  |  |  |  | v1 | v1 | v1 | v1 | v1 |
