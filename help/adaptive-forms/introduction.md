...
| Datuminvoerveld | ✔️ | | | Voor de Componenten van de Kern, gebruik de [ component van de plukker van 0} datum. ](/help/adaptive-forms/components/date-picker.md) U kunt afzonderlijke [ textbox ](/help/adaptive-forms/components/text-box.md) of [ numerieke doos ](/help/adaptive-forms/components/numeric-box.md) componenten ook toevoegen om de dag, de maand, en het jaar te vangen. |
