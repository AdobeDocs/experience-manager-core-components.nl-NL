...
<!-- 1. [Enable Adaptive Form Core Components](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/content/forms/setup-configure-migrate/enable-adaptive-forms-core-components.html?lang=nl-NL) -->
1. [Implementeer een AEM Archetype 47-project of hoger in uw omgeving](https://github.com/adobe/aem-project-archetype)
...
![Overzicht werknemersbeloningen &#x200B;](/help/adaptive-forms/assets/Employee-benefits-summary.png)
