...
De knop Verzenden is doorgaans de laatste stap in het invullen van het formulier en wordt gebruikt om het verzenden van de formuliergegevens naar de server te starten.
...
De Adaptive Forms Submit knop Core Component is in februari 2023 uitgebracht als onderdeel van Core Components 2.0.4. Hier volgt een tabel met alle ondersteunde versies, AEM compatibiliteit en koppelingen naar de bijbehorende documentatie:
...
Het dialoogvenster Ontwerpen wordt gebruikt om CSS-stijlen voor een component te definiëren en te beheren. De kerncomponent van de knop Adaptief Forms verzenden ondersteunt de AEM [Stijlsysteem](/help/get-started/authoring.md#component-styling).

**Standaard CSS-klassen**: U kunt een standaard CSS-klasse opgeven voor de Adaptive Forms Submit-kerncomponent van de knop.
