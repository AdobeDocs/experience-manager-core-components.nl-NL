...
Op het tabblad Indelingen kunt u standaard- en aangepaste datumnotaties opgeven. Bovendien, kunt u nieuw formaat van de douanedatum ook toevoegen gebruikend **voeg** knoop toe.
...
2. In de **Toegestane sectie van Componenten**, selecteer de **[!UICONTROL Date Picker]** component.
   ![ het malplaatjebeleid van de Plukker van de Datum ](/help/adaptive-forms/assets/date-picker-policy.png)
3. Klik op het pictogram **[!UICONTROL Add]** om een nieuw beleid voor de component Date Picker te maken.
4. Ga een naam voor het beleid in en selecteer alle vereiste formaten onder het **Formaat** lusje.
   ![ creeer Beleid ](/help/adaptive-forms/assets/number-input-format-policy.png)
