...
Het tabblad wordt gebruikt om CSS-stijlen voor een component te definiëren en te beheren. De Adaptive Forms Phone Core-component ondersteunt de AEM [Stijlsysteem](/help/get-started/authoring.md#component-styling).

![Ontwerpdialoogvenster](/help/adaptive-forms/assets/telephoneinput_designdialog.png)

- **Standaard CSS-klassen**: U kunt een standaard CSS-klasse opgeven voor de Adaptive Forms Phone Core-component.
...
![Dialoogvenster Aangepaste eigenschappen](/help/adaptive-forms/assets/telephoneinput-customproperties.png)
...
Op het tabblad Validatiepatroon kunt u waarden invoeren in een specifieke notatie of aan bepaalde criteria voldoen. Sommige opties zijn standaard beschikbaar, die u kunt selecteren door het bijbehorende selectievakje in te schakelen. Bovendien kunt u een aangepaste indeling toevoegen door op de knop **Toevoegen** knop.
