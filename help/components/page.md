...
Versie 2.15.0 van de Componenten van de Kern introduceerde steun voor AEM as a Cloud Service ingebouwde [&#x200B; Progressieve eigenschappen van het Web van Apps (PWA).](https://experienceleague.adobe.com/docs/experience-manager-cloud-service/sites/authoring/features/enable-pwa.html) Met een eenvoudige configuratie op siteniveau verandert u uw AEM-ervaring in een PWA!
