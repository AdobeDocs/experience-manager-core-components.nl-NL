...
* **Voorwaarde** - de voorwaarde die voor dit segment moet worden voldaan om aan de ontvanger van de inhoud te worden getoond.
   ...
   * **Douane** - staat de auteur toe om een voorwaarde te bepalen
      ...
      * [Zie hier voor personalisatiebronnen van Adobe Campaign Standard.](https://experienceleague.adobe.com/docs/campaign-standard/using/designing-content/personalization.html?lang=nl-NL&)
      * [Zie hier voor personalisatiebronnen van Adobe Campaign Classic.](https://experienceleague.adobe.com/docs/campaign-classic/using/sending-messages/personalizing-deliveries/personalization-fields.html?lang=nl-NL)
